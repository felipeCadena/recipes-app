  ...
  return (
    ...
    <div className='profile-container'>
      ...
      <Link to="/done-recipes">
        ...
        src={aprovado} alt="icone-aprovado" />
        <button 
        className='done-btn btn btn-light'
        data-testid="profile-done-btn">Done Recipes</button>
      </Link>
      <Link to="/favorite-recipes">
      <img 
      className='coracao-img'
      src={coracao} alt="icone-coracao" />
        <button
        className='favorite-btn btn btn-light'
        data-testid="profile-favorite-btn">Favorite Recipes</button>
      </Link >
      <img 
      className='logout-img'
      src={logout} alt="icone-logout" />
      <button
      className=' logout-btn btn btn-light'
      onClick={ handleLogout } data-testid="profile-logout-btn">Logout</button>
      </div>
    </div>
    </header>
  );
